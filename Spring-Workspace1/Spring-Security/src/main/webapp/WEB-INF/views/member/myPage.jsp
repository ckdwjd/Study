...
<body>
	...
	<div class="outer">
		...
		<form:form id="enroll-form" action="${pageContext.request.contextPath }/update.me" method="post">
			<!-- 회원가입form안에.txt -->
			<table align="center">
				<tr>
					<td>* ID</td>
				...
				<tr>
					...
					<input type="radio" name="gender" value="M" ${principal.gender == 'M' ? "checked" : "" } checked> 남 
					<input type="radio" name="gender" value="F" ${principal.gender == 'F' ? "checked" : "" }> 여</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;PHONE</td>
