...
public class MemberController {
	...
	public String myPage(Model model, 
			// 2. HandlerMapping에 보안인증된 사용자 Authentication 요청
			Authentication authentication) {

		// 1. SecurityContextHolder로 부터 사용자의 인증정보 가져오기
	...
	public String updateMember(
		...
		// 1. 업무로직 : DB의 Member테이블에 회원정보 수정요청을 보낸 회원 정보 수정 => 생략
		
		
		// 2. 변경된 회원정보를 DB에서 얻어온 후 Session에 저장하는 대신
		//	  SecurityContext의 Authentication객체를 직접 수정
