...
public class AirPollutionTest {
	...
	public String[] locaitons = {"전국","서울","부산","대구","인천","광주","대전","울산","경기","강원","충북","충남","전북","전남","경북","경남","제주","세종"};
	...
	// 간단한 테스트환경은 src/test/java에 구현
	
	// JUnit : 자바프로그래밍 언어용 유닛 테스트 프레임워크
	// @Test : JUnit이라는 도구를 이용해서 테스트가 가능하도록 설정(굳이 main메서드를 만들필요없음)
//	@Test
	public void testRun(String location) throws IOException {
		
		
		// OpenAPI 서버로 요청하고자 하는 URL
