...
public class MemberView {
	...
	/**
	 * 사용자에게 변경할 회원의 아이디, 변경할 정보들(비번,이메일,휴대폰,주소) 입력받은 후
	 * 변경 요청하는 메서드
	 */
	public void updateMember() {
		...
		System.out.print("변경할 휴대폰번호(숫자만) 입력 : ");
		String phone = sc.nextLine();
	...
	/**
	 * 사용자에게 탈퇴할 회원의 아이디 + 비밀번호를 입력받은 후 삭제 요청하는 메서드
	 */
	public void deleteMember() {
		...
		System.out.print("탈퇴할 회원 비밀번호 입력 : ");
		String userPwd = sc.nextLine();
